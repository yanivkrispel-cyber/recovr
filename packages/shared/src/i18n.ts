...
export const he = {
  ...
  'catalog.media.verified': 'עם מדיה מאומתת',
  'catalog.media.unverified': 'מדיה לא מאומתת',
  ...
  'catalog.save.auto': 'נשמר אוטומטית — אין צורך בכפתור שמירה',
  ...
  'catalog.usage.attach.already': 'התרגיל כבר נמצא בשלב הזה של הפרוטוקול',
  'catalog.usage.attach.copied': 'נוצר עותק פרטי "{name}" במרפאה שלך והתרגיל נוסף אליו',
  'catalog.usage.attach.group.clinic': 'פרוטוקולים של המרפאה',
  'catalog.usage.attach.group.system': 'פרוטוקולי קטלוג המערכת',
  'catalog.usage.attach.hint.master': 'את/ה מוסיף/ה לפרוטוקול של קטלוג המערכת — השינוי יחול על כל המרפאות. מטופלים שכבר משובצים לא יושפעו.',
  'catalog.usage.attach.hint.copy': 'זהו פרוטוקול של קטלוג המערכת. ייווצר עותק פרטי של הפרוטוקול במרפאה שלך, והתרגיל יתווסף לעותק.',
  ...
  // Exercise media manager (T-31)
  'media.rights.own': 'צולם / נוצר על ידינו',
  'media.rights.licensed': 'ברישיון',
  'media.rights.open': 'חופשי לשימוש',
  'media.rights.embed': 'הטמעה (YouTube)',
  'media.rights.unknown': 'זכויות לא ידועות',
  'media.kind.image': 'תמונה',
  'media.kind.gif': 'GIF',
  'media.kind.clip': 'סרטון',
  'media.kind.video': 'YouTube',
  'media.scope.master': 'קטלוג',
  'media.scope.clinic': 'של המרפאה',
  'media.primary': 'ראשית',
  'media.make_primary': 'הפוך לראשית',
  'media.verified': 'מאומת',
  'media.pending': 'ממתין לאימות',
  'media.verify': 'אמת',
  'media.unverify': 'בטל אימות',
  'media.remove': 'הסר',
  'media.remove.confirm': 'להסיר את המדיה מהתרגיל?',
  'media.rights.label': 'זכויות שימוש',
  'media.attribution': 'קרדיט / מקור',
  'media.trim': 'קטע להצגה',
  'media.trim.start': 'מ-',
  'media.trim.end': 'עד',
  'media.trim.invalid': 'טווח זמן לא תקין (דקות:שניות)',
  'media.drop.title': 'גררו לכאן קבצים או לחצו לבחירה',
  'media.drop.hint': 'תמונה (JPG/PNG/WebP עד 5MB), GIF עד 15MB, סרטון MP4/WebM עד 50MB',
  'media.upload.rights_required': 'בחרו את זכויות השימוש לפני ההעלאה',
  'media.upload.verify': 'המדיה מציגה את התרגיל נכון — אשר להצגה למטופלים',
  'media.upload.uploading': 'מעלה {name}…',
  'media.upload.done': 'המדיה נוספה',
  'media.upload.failed': 'ההעלאה נכשלה: {name}',
  'media.upload.unsupported': 'סוג קובץ לא נתמך: {name}',
  'media.upload.too_large': 'הקובץ גדול מדי: {name}',
  'media.youtube.add': 'הוסף סרטון YouTube',
  'media.youtube.placeholder': 'קישור YouTube',
  'media.youtube.submit': 'הוסף סרטון',
  'media.youtube.pending': 'הסרטון עוד לא נשמר — לחצו "הוסף סרטון" (או Enter)',
  'catalog.field.video.invalid': 'קישור YouTube לא תקין',
  'media.youtube.exists': 'כבר קיים סרטון YouTube בהיקף הזה — ערכו או הסירו אותו',
  'media.master_readonly': 'מדיה מקטלוג המערכת מנוהלת על ידי צוות הקטלוג. מדיה שתוסיפו כאן תהיה של המרפאה שלכם בלבד.',
  'media.curator_scope': 'מדיה שתוסיפו כאן תתווסף לקטלוג המערכת, לכל המרפאות.',
  'media.not_shown_hint': 'רק מדיה מאומתת מוצגת למטופלים ובתדפיס. הראשונה ברשימה היא התמונה הראשית.',
  'media.empty': 'אין עדיין מדיה לתרגיל הזה',
  'media.queue.title': 'אימות מדיה',
  'media.queue.status.pending': 'ממתינים',
  'media.queue.status.verified': 'מאומתים',
  'media.queue.status.rights_unknown': 'זכויות לא ידועות',
  'media.queue.status.all': 'הכל',
  'media.queue.source': 'מקור',
  'media.queue.source.dataset': 'מאגר מקור',
  'media.queue.source.upload': 'הועלו',
  'media.queue.source.youtube': 'YouTube',
  'media.queue.only_approved': 'רק תרגילים מאושרים',
  'media.queue.empty': 'אין מדיה בתור הזה',
  'media.queue.verify_selected': 'אמת {n} נבחרים',
  'media.queue.set_rights': 'זכויות לאימות…',
  'media.queue.open_exercise': 'פתח תרגיל',
  'media.queue.rights_warning': 'אומת לפני תיעוד זכויות — יש להשלים זכויות',
  'media.import.title': 'ייבוא מדיה מרוכז',
  'media.import.open': 'ייבוא מדיה',
  'media.import.pick': 'בחרו קבצים (שם הקובץ ישמש להתאמה לתרגיל)',
  'media.import.matching': 'מתאים שמות קבצים לתרגילים…',
  'media.import.col.file': 'קובץ',
  'media.import.col.exercise': 'תרגיל',
  'media.import.no_match': 'לא נמצאה התאמה — בחרו ידנית',
  'media.import.skip': 'דלג',
  'media.import.search': 'חיפוש תרגיל…',
  'media.import.start': 'העלה {n} קבצים',
  'media.import.progress': 'הועלו {done} מתוך {total}',
  'media.import.summary': 'הועלו {ok} · נכשלו {failed} · דולגו {skipped}',
  'media.import.primary': 'קבע כמדיה ראשית',
