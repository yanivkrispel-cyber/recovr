// Edge Function: GET /me/education
// Returns the current patient's phase education content per API_CONTRACT.md.
...
Deno.serve(async (req) => {
  ...
  const { data: result, error: rpcErr } = await service
    .schema('app')
    .rpc('patient_education', { p_patient_auth_id: user.id });
